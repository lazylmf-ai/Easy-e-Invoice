...
export const createJobCompletionNotification = (
  recipient: NotificationRecipient,
  organizationId: string,
  jobData: JobCompletionData
): NotificationPayload => {
...
export const createCsvImportNotification = (
  recipient: NotificationRecipient,
  organizationId: string,
  fileName: string,
  results: {
...
export const createMyInvoisNotification = (
  recipient: NotificationRecipient,
  organizationId: string,
  myInvoisData: MyInvoisData
): NotificationPayload => {
