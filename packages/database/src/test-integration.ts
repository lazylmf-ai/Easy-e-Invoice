// Test integration between database schema and validation package
...
const mockOrg: schema.Organization = {
  id: 'test-org-id',
...
const mockInvoice: schema.Invoice = {
  id: 'test-invoice-id',
  orgId: 'test-org-id',
  buyerId: null,
  templateId: null,
...
const mockLines: schema.InvoiceLine[] = [
  {
    id: 'test-line-id',
