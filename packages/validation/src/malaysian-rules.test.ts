...
const createTestInvoiceLine = (overrides = {}): InvoiceLine => ({
  lineNumber: 1,
...
const createCompleteInvoice = (overrides = {}): CompleteInvoice => ({
...
describe('Validation Score Calculation', () => {
  ...
  it('should not go below 0', () => {
    const results: ValidationResult[] = MALAYSIAN_VALIDATION_RULES.map(rule => ({
      ruleCode: rule.code,
